package com.example.batch.my_batch_job.jobs;
...
import com.example.batch.my_batch_job.job01.Employee;
import com.example.batch.my_batch_job.job01.EmployeeProcessor;

@Configuration
@Import(JobBaseContextConfig.class)
@ComponentScan("com.example.batch.my_batch_job.job01")
@MapperScan(basePackages = "com.example.batch.my_batch_job.job01", sqlSessionFactoryRef = "jobSqlSessionFactory")
